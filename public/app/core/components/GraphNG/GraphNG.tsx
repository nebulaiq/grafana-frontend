...
export class GraphNG extends Component<GraphNGProps, GraphNGState> {
  ...
  componentDidMount() {
    // Series visibility is now handled through field config (custom.hideFrom.viz)
    // VizPanel's onToggleSeriesVisibility updates field config, which triggers
    // data reprocessing and proper filtering of hidden series
  }
