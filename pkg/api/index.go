...
func (hs *HTTPServer) setIndexViewData(c *contextmodel.ReqContext) (*dtos.IndexViewData, error) {
	...
	data := dtos.IndexViewData{
		...
		AppNameBodyClass:                    "app-nebulaiq",
		FavIcon:                             "public/img/nebulaiq-icon.svg",
		AppleTouchIcon:                      "public/img/nebulaiq-icon.svg",
		AppTitle:                            "NebulaIQ Telemetry",
		NavTree:                             navTree,
		Nonce:                               c.RequestNonce,
		LoadingLogo:                         "public/img/nebulaiq-icon.svg",
